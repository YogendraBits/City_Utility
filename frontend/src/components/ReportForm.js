...
const ReportForm = () => {
  ...
  const [location, setLocation] = useState({
    ...
    postalCode: '',
    country: '',
    coordinates: ['', ''], // Changed to strings to allow text input
  });
    ...
    <div className="report-form-container">
      ...
      <main className="report-form-main">
        ...
        <form onSubmit={handleSubmit} className="report-form">
            ...
            <div className="coordinates">
              <label>
                ...
                <input
                  ...
                  onChange={(e) => handleLocationChange('coordinates', [location.coordinates[0], e.target.value])}
              ...
              <label>
                ...
                <input
                  ...
                  onChange={(e) => handleLocationChange('coordinates', [e.target.value, location.coordinates[1]])}
          ...
          <div className="report-form-actions">
            <button type="button" onClick={fetchLocation} className="report-form-fetch-location-button">Fetch Location</button>
            <label className="report-form-email-option">
              <input
                type="checkbox"
                checked={sendEmailOption}
      ...
      {showPopup && (
        <div className="popup-overlay">
          <div className="popup-content">
            ...
            <button onClick={handlePopupClose} className="popup-button">My Records</button>
          </div>
        </div>
      )}
    </div>
